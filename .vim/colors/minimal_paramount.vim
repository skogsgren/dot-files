...
let g:colors_name='minimal_paramount'
...
let s:dark_blue       = { "gui": "#1717ff", "cterm": "32"   }
...
call s:h("Cursor",        {"bg": s:dark_blue, "fg": s:norm })
...
call s:h("Statement",     {"cterm": "bold", "gui": "bold"})
...
call s:h("PreProc",     {"fg": s:norm_subtle, "gui": "italic", "cterm": "italic"})
hi! link Include          PreProc
hi! link Define           PreProc
hi! link Macro            PreProc
hi! link PreCondit        PreProc

call s:h("Type",          {"fg": s:norm, "cterm": "italic", "gui": "italic"})
